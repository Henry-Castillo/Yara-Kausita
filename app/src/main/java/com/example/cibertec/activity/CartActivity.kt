...
import com.example.cibertec.adapter.CartOrderRecyclerAdapter
import com.example.cibertec.database.CartDatabase
import com.example.cibertec.database.CartEntity
import com.example.cibertec.model.FoodItemModel
...
class CartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val totalCostString = "Tomar Orden(Total: S/. $totalCost )"
    ...
    private fun sendRequest(totalCost: Int) {
        ...
        if (ConnectionManager().checkConnectivity(this@CartActivity)) {
            ...
            Toast.makeText(this@CartActivity, "Necesita Conection a Internet", Toast.LENGTH_SHORT).show()
        }
    }
