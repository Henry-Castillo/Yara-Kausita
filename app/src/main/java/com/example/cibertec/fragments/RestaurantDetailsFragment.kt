...
import com.example.cibertec.activity.CartActivity
import com.example.cibertec.adapter.HomeRecyclerAdapter
import com.example.cibertec.adapter.RestaurantDetailsRecyclerAdapter
import com.example.cibertec.database.CartDatabase
import com.example.cibertec.database.CartEntity
import com.example.cibertec.database.FavouriteEntity
import com.example.cibertec.model.CartDetails
...
class RestaurantDetailsFragment(private val resObject: FavouriteEntity) : Fragment() {
    ...
    private fun setUpRestaurantMenu(view: View) {
        ...
        if (ConnectionManager().checkConnectivity(activity as Context)) {
            ...
            Toast.makeText(activity as Context, "Sin coneccion a internet", Toast.LENGTH_SHORT).show()
        }
    }
