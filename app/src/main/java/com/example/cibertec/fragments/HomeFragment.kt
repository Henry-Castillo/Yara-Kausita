...
import com.example.cibertec.activity.MainActivity
...
import com.example.cibertec.utility.Sorter
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (ConnectionManager().checkConnectivity(activity as Context)) {
            ...
            dialog.setMessage("No se encuentra la conexión a Internet")
            dialog.setPositiveButton("Configuración abierta") { _, _ ->
